...
if has("gui_running")
	...
	hi StatusLine     guibg=#1F1F1F guifg=#696567 gui=none
	hi StatusLineNC   guibg=#25365a guifg=#696567 gui=none

	" -> Messages
	hi ErrorMsg       guibg=#A32024 guifg=#D0D0D0 gui=none
	hi Question       guibg=#000000 guifg=#FFA500 gui=none
	hi WarningMsg     guibg=#FFA500 guifg=#000000 gui=none
	hi MoreMsg        guibg=#000000 guifg=#FFA500 gui=none
	hi ModeMsg        guibg=#000000 guifg=#FFA500 gui=none
	...
	" -> Tabs
	hi TabLine        guibg=#141414 guifg=#373737 gui=none
	hi TabLineFill    guibg=#1F1F1F               gui=none
	hi TabLineSel     guibg=#000000 guifg=#D0D0D0 gui=bold
	"
	" -> Visual Mode
	hi Visual         guibg=#1F1F1F guifg=#FFB539 gui=none
	hi VisualNOS      guibg=#1F1F1F guifg=#696567 gui=none

	" -> Code
	hi Comment        guibg=#000000 guifg=#696567 gui=none
	hi Constant       guibg=#000000 guifg=#6DF584 gui=none
	hi String         guibg=#000000 guifg=#FFB539 gui=none
	hi Error          guibg=#000000 guifg=#FC4234 gui=none
	hi Identifier     guibg=#000000 guifg=#70BDF1 gui=none
	hi Function       guibg=#000000 guifg=#90CBF1 gui=none
	hi Ignore         guibg=#000000 guifg=#1F1F1F gui=none
	hi MatchParen     guibg=#FFA500 guifg=#1F1F1F gui=none
	hi PreProc        guibg=#000000 guifg=#BF81FA gui=none
	hi Special        guibg=#000000 guifg=#FFEE68 gui=none
	hi Todo           guibg=#000000 guifg=#FC4234 gui=bold
	hi Underlined     guibg=#000000 guifg=#FC4234 gui=underline
	hi Statement      guibg=#000000 guifg=#E783E9 gui=none
	hi Operator       guibg=#000000 guifg=#FC6984 gui=none
	hi Delimiter      guibg=#000000 guifg=#FC6984 gui=none
	hi Type           guibg=#000000 guifg=#FFEE68 gui=none
	hi Exception      guibg=#000000 guifg=#FC4234 gui=none

	" -> HTML-specific
	hi htmlBold                 guibg=#000000 guifg=#D0D0D0 gui=bold
	hi htmlBoldItalic           guibg=#000000 guifg=#D0D0D0 gui=bold,italic
	hi htmlBoldUnderline        guibg=#000000 guifg=#D0D0D0 gui=bold,underline
	hi htmlBoldUnderlineItalic  guibg=#000000 guifg=#D0D0D0 gui=bold,underline,italic
	hi htmlItalic               guibg=#000000 guifg=#D0D0D0 gui=italic
	hi htmlUnderline            guibg=#000000 guifg=#D0D0D0 gui=underline
	hi htmlUnderlineItalic      guibg=#000000 guifg=#D0D0D0 gui=underline,italic
...
elseif &t_Co == 256
	...
	" -> Menu
	hi Pmenu          ctermbg=11  ctermfg=0    cterm=none
	hi PmenuSel       ctermbg=208 ctermfg=0    cterm=none
	...
	hi TabLineSel     ctermbg=0  ctermfg=252   cterm=bold
	"
	" -> Visual Mode
	...
	" -> Code
	hi Comment        ctermbg=0  ctermfg=245   cterm=none
	hi Constant       ctermbg=0  ctermfg=84    cterm=none
	hi String         ctermbg=0  ctermfg=215   cterm=none
	hi Error          ctermbg=0  ctermfg=203   cterm=none
	hi Identifier     ctermbg=0  ctermfg=75    cterm=none
	hi Function       ctermbg=0  ctermfg=117   cterm=none
	hi Ignore         ctermbg=0  ctermfg=234   cterm=none
	hi MatchParen     ctermbg=214  ctermfg=234   cterm=none
	hi PreProc        ctermbg=0  ctermfg=141   cterm=none
	hi Special        ctermbg=0  ctermfg=227   cterm=none
	hi Todo           ctermbg=0  ctermfg=203   cterm=bold
	hi Underlined     ctermbg=0  ctermfg=203   cterm=underline
	hi Statement      ctermbg=0  ctermfg=176   cterm=none
	hi Operator       ctermbg=0  ctermfg=204   cterm=none
	hi Delimiter      ctermbg=0  ctermfg=204   cterm=none
	hi Type           ctermbg=0  ctermfg=227   cterm=none
	hi Exception      ctermbg=0  ctermfg=203   cterm=none
